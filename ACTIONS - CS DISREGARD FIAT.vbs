...
DO
	...
	Dialog CSD_FIAT_dlg
		...
		If footer_month = "" then err_msg = err_msg & vbCr & "* You must have a starting footer month to continue."
		If footer_year = "" then err_msg = err_msg & vbCr & "* You must have a starting footer year to continue."
